...
const PresentationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/presentations/', submissionData);
      ...
      setError(error.response?.data?.message || 'Error submitting presentation. Please try again.');
    } finally {
